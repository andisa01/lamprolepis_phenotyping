...
![Phenotypes of iNaturalist records of *Lamprolepis smaragdina* mapped to observation coordinates. Important locations are noted, including Kosrae Island where the *La Coquille* expedition was at port when Lesson first describe the species and two important export hubs in Indonesia (Makassar) and The Solomon Islands (Honiara).](./figs/Fig_mapmainv3.jpg)

## Repository purpose

This repository is intended as the reproducible research companion to the article. It includes the underlying data, phenotyping outputs, figures, and analysis code used to examine geographic patterning in *Lamprolepis smaragdina* phenotypes and to compare those patterns with published phylogeography, historical taxonomy, and trade data.

## Contents

-   `data/` — processed datasets used in the analysis
-   `figs/` — example, post-production figures
-   `scripts/` — code used for cleaning, analysis, and visualization
